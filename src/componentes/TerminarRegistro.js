...
function TerminarRegistroForm({
  ...
  const [inputEstadoCivil, set_inputEstadoCivil] = useState({
    valor: '',
    validado: false,
    textoAyuda: ""
  });
  const [inputVivienda, set_inputVivienda] = useState({
    valor: '',
    validado: false,
    textoAyuda: ""
  });
  const [inputTipoIngresos, set_inputTipoIngresos] = useState({
    valor: '',
    validado: false,
    textoAyuda: ""
  });
  const [inputIngresosMensuales, set_inputIngresosMensuales] = useState({
    valor: '',
    validado: false,
    textoAyuda: ""
  });
  const [inputNumeroDependientes, set_inputNumeroDependientes] = useState({
    valor: '',
    validado: false,
    textoAyuda: ""
  });
  ...
  const [inputTipoNegocio, set_inputTipoNegocio] = useState({
    valor: '',
    validado: false
  });
  ...
  useEffect(() => {
    ...
    if (inputTipoIngresos.valor === 'comerciante') {
      if (inputBanco.validado && inputCuentaBanco.validado && inputEstadoCivil.validado && inputTipoIngresos.validado && inputVivienda.validado && inputNumeroDependientes.validado && inputIngresosMensuales.validado && inputFechaIngresoTrabajo.validado && inputTipoNegocio.validado) {
        set_botonEnviarHabilitado(true);
      }
    }
    if (inputTipoIngresos.valor === 'asalariado') {
      if (inputBanco.validado && inputCuentaBanco.validado && inputEstadoCivil.validado && inputTipoIngresos.validado && inputVivienda.validado && inputNumeroDependientes.validado && inputIngresosMensuales.validado && inputFechaIngresoTrabajo.validado) {
        set_botonEnviarHabilitado(true);
      }
    }
  ...
  return <Box sx={{
    p: '4px'
      ...
      pb: 3
          ...
          pt: 1,
          pb: 3
        }}>Se registro correctamente.</Typography>
          ...
          mb: 1
              ...
              }} required error={!inputBanco.validado && inputBanco.blur}>Banco</InputLabel>
                            <Select onBlur={() => {
                set_inputBanco({
                  ...inputBanco,
                  blur: true
                });
              }} required value={inputBanco.valor} onChange={handleChange_inputBanco} label="Banco" error={!inputBanco.validado && inputBanco.blur}>
                  ...
                  return key ? <MenuItem key={key} value={key}>{apiCamposConstructor?.bank?.values[key]}</MenuItem> : '';
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField helperText={inputCuentaBanco.textoAyuda} required value={inputCuentaBanco.valor} onBlur={() => {
              set_inputCuentaBanco({
                ...inputCuentaBanco,
                blur: true
              });
            }} onChange={handleChange_inputCuentaBanco} error={!inputCuentaBanco.validado && inputCuentaBanco.blur} autoComplete="off" fullWidth label={"# de cuenta (" + apiCamposConstructor?.bank?.values[inputBanco.valor] + ")."} />
              ...
              }} required error={!inputVivienda.validado && inputVivienda.blur}>Vivienda</InputLabel>
                            <Select onBlur={() => {
                set_inputVivienda({
                  ...inputVivienda,
                  blur: true
                });
              }} required value={inputVivienda.valor} onChange={handleChange_inputVivienda} label="Vivienda" error={!inputVivienda.validado && inputVivienda.blur}>
              ...
              }} required error={!inputNumeroDependientes.validado && inputNumeroDependientes.blur}># de dependientes</InputLabel>
                            <Select onBlur={() => {
                set_inputNumeroDependientes({
                  ...inputNumeroDependientes,
                  blur: true
                });
              }} required value={inputNumeroDependientes.valor} onChange={handleChange_inputNumeroDependientes} label="# de dependientes" error={!inputNumeroDependientes.validado && inputNumeroDependientes.blur}>
              ...
              }} required error={!inputTipoIngresos.validado && inputTipoIngresos.blur}>Actividad comercial</InputLabel>
                            <Select onBlur={() => {
                set_inputTipoIngresos({
                  ...inputTipoIngresos,
                  blur: true
                });
              }} required value={inputTipoIngresos.valor} onChange={handleChange_inputTipoIngresos} label="Actividad comercial" error={!inputTipoIngresos.validado && inputTipoIngresos.blur}>
                  ...
                  return key ? <MenuItem key={key} value={apiCamposConstructor?.income_status?.values[key]}><span className="capitalize">{apiCamposConstructor?.income_status?.values[key]}</span></MenuItem> : '';
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField autoComplete="off" fullWidth label="Ingreso mensuales" required onBlur={() => {
              set_inputIngresosMensuales({
                ...inputIngresosMensuales,
                blur: true
              });
            }} value={inputIngresosMensuales.valor} onChange={handleChange_inputIngresosMensuales} error={!inputIngresosMensuales.validado && inputIngresosMensuales.blur} helperText={inputIngresosMensuales.textoAyuda} />

                    </Grid>
                    {inputTipoIngresos.valor === 'comerciante' && <Grid item xs={12} sm={6}>
                        <FormControl fullWidth>
                            <InputLabel onBlur={() => {
                set_inputTipoNegocio({
                  ...inputTipoNegocio,
              ...
              }} required error={!inputTipoNegocio.validado && inputTipoNegocio.blur}>Tipo de negocio</InputLabel>
                            <Select onBlur={() => {
                set_inputTipoNegocio({
                  ...inputTipoNegocio,
                  blur: true
                });
              }} required value={inputTipoNegocio.valor} onChange={handleChange_inputTipoNegocio} label="Tipo de negocio" error={!inputTipoNegocio.validado && inputTipoNegocio.blur}>
              ...
              }} required error={!inputEstadoCivil.validado && inputEstadoCivil.blur}>Estado Cívil</InputLabel>
                            <Select onBlur={() => {
                set_inputEstadoCivil({
                  ...inputEstadoCivil,
                  blur: true
                });
              }} required value={inputEstadoCivil.valor} onChange={handleChange_inputEstadoCivil} label="Estado Cívil" error={!inputEstadoCivil.validado && inputEstadoCivil.blur}>
                  ...
                  return key ? <MenuItem key={key} value={key}>{apiCamposConstructor?.marital_status?.values[key]}</MenuItem> : '';
                    ...
                    <Grid item xs={12} sm={6}>
                        <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={"es"}>
                            <DatePicker fullWidth openTo="year" maxDate={moment().subtract(0, 'years')._d} minDate={moment().subtract(20, 'years')._d} label="Inicio de labores" value={inputFechaIngresoTrabajo.valor} onChange={handleChange_inputFechaIngresoTrabajo} renderInput={params => <TextField {...params} autoComplete="off" onBlur={() => {
                set_inputFechaIngresoTrabajo({
                  ...
                  blur: true
                    ...
                    <Grid item xs={12} sm={12}>
                        <Button onClick={enviarARegistroApi2} disabled={!botonEnviarHabilitado || cargandoRegister2} variant="contained" sx={{
              mt: 1,
              mr: 1
              ...
              mr: 1
                ...
                {!apiCamposConstructor && <Typography variant="body2" sx={{
          p: '2rem 0',
          color: 'silver'
        }}>Cargando....</Typography>}
                </>}
...
function TerminarRegistro({
  ...
  return <Dialog fullScreen={fullScreen} onClose={cerrar} open={open} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
