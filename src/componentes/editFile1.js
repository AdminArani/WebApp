...
function FormEditFile1({
  ...
  return <Box>
      ...
      mt: 1,
      mb: 1
    }} container spacing={2} alignItems="stretch" // Asegura que las columnas tengan la misma altura
    >
                <Grid item xs={12} sm={6} sx={{
        display: 'flex',
        flexDirection: 'column'
      }}>
                    {subidoArchivo1 && <Typography sx={{
          textAlign: 'center',
          color: '#5aad55'
        }}>
                            Se subió correctamente
                        </Typography>}
                    {(subidoArchivo1 || imageFiles1) && <img className="imgprevperfil" src={imagendata1 || imageFiles1} alt="preview" style={{
          width: '100%',
          height: 'auto',
          flexGrow: 1
        }} />}
        ...
        flexDirection: 'column'
                    ...
                    <img src={logoArani} // Usa la imagen importada
        alt="Logo Arani" style={{
          width: '100%',
          height: 'auto',
          flexGrow: 1
        }} />
