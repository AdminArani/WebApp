    ...
    function handleChange_inputIdentidad(event) {
        ...
        if (diffcaracteres === 0) {
            ...
            fetch(url)
                ...
                .then(data => {
                    console.log("Respuesta del endpoint validarDatosCenso:", data);
                                ...
                                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={"es"}>
                                    <DatePicker
                                        ...
                                        renderInput={(params) => (
                                            <TextField 
                                                {...params} 
                                                onBlur={()=>{set_inputFechaNac({...inputFechaNac, blur: true})}} 
                                                autoComplete="off" 
                                                fullWidth 
                                                required 
                                                helperText={inputFechaNac.textoAyuda} 
                                                error={(!inputFechaNac.validado && inputFechaNac.blur)} 
                                            />
                                        )}
                                    />
