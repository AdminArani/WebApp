...
function Perfil() {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(async position => {
      ...
      try {
        ...
        const ubicacionesPermitidas = ["Tegucigalpa, Honduras", "Comayagüela, Honduras", "Valle de Angeles, Honduras", "Choloma, Honduras", "La Lima, Honduras", "Villanueva, Honduras", "Progreso, Honduras", "San Pedro Sula, Honduras", "Puerto Cortés, Honduras", "El Progreso, Honduras", "Danlí, Honduras", "Choluteca, Honduras", "Comayagua, Honduras", "Siguatepeque, Honduras", "La Ceiba, Honduras", "La Paz, Honduras", "Santa Rosa de Copán, Honduras", "Gracias, Honduras", "Roatán, Honduras", "French Harbour, Honduras", "Santa Rosa, Honduras"];
  ...
  async function validarPerfilEnCore(callback) {
    // Para saber si ya esta registrado en el CORE o no
    try {
      ...
      if (status === "ER") {
        ...
        if (datosPerfilIniciales.current === null) {
          datosPerfilIniciales.current = JSON.stringify(payload.data);
        }
    ...
    justifyContent: "center"
      ...
      width: '100%'
        ...
        p: 4
            ...
            textAlign: 'center',
            color: 'silver'
          }}><CircularProgress /><br></br>Cargando.... </Typography>
                    </Box>}
                    {faltaTerminarRegistro && !cargando && !cargando2 && apiCamposConstructor && <Box sx={{
          p: '6rem 0',
          textAlign: 'center'
        }}>
                        <Typography variant="body2" sx={{
            ...
            maxWidth: '20rem',
            margin: '0 auto'
          }}>Aún falta completar el registro para acceder a esta sección.</Typography>
                        <Button onClick={() => {
            set_openterminarreg(true);
          ...
          pb: 6
                        ...
                        <div className="tarjetaperfil">
                            ...
                            {!usuarioDetalle.file4 && <div className="tarjetaperfil-p1"><span style={{
                fontSize: '8rem',
                paddingRight: '1rem'
              }} className="material-symbols-outlined">account_circle</span></div>}
                            {usuarioDetalle.file4 && <div className="tarjetaperfil-p1"><Avatar sx={{
                height: '8rem',
                width: '8rem',
                mr: '2rem'
              }} alt="Remy Sharp" src={urlImagenPerfilTerminada} /></div>}
                      ...
                      color: '#ffffff'
                                            ...
                                            <ListItemText primary={<Typography variant="body2" sx={{}}>Cuenta virtual: L {numeral(walletData.amount_wallet_balance).format('0,0.[00]')} Saldo</Typography>} />
                                    ...
                                    <Typography variant="body2" sx={{
                  opacity: 0.6
                }}>Fecha de registro: {moment(usuarioDetalle.created).format("LL")}</Typography>
                                    <Typography variant="body2" sx={{
                  opacity: 0.6
                }}>Id de usuario: {usuarioDetalle.customer_id}</Typography>
            ...
            color: '#ff8100'
                        ...
                        {usuarioAprobadoManual && <Box>
                                <Typography variant="body2" sx={{
              color: '#64d164'
            }}>Tu cuenta esta habilitada para solicitar préstamos.</Typography>
                                {/* {showAplicarLink ? (
                ...
                m: '0 0 2rem 0',
                color: 'silver'
              }}>Información general de la cuenta, selecciona para editar.</Typography>
                            </Grid>
                  ...
                  set_moduloEditarActivo('cambiarpass');
                  set_openEditarCampos(true);
                            ...
                            <Grid item xs={12} sm={6}>
                                <List>
                                    <ListItemButton onClick={() => {
                  set_moduloEditarActivo('telefono');
                  set_openEditarCampos(true);
                }}>
                                        <ListItemIcon>
                ...
                style={{
                  cursor: usuarioDetalle.status === "1" ? "not-allowed" : "pointer",
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                    ...
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.income_status || "----"} secondary="* Tipo de ingreso" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Banco" sx={estiloCampoFaltante('Banco')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Estado civil" sx={estiloCampoFaltante('Estado civil')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primary={apiCamposConstructor.marital_status?.values[usuarioDetalle.marital_status] || "----"} secondary="* Estado civil" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Ingreso mensual" sx={estiloCampoFaltante('Ingreso mensual')} onClick={() => {
                ...
                style={{
                  cursor: usuarioDetalle.status === "1" || usuarioDetalle.income && parseInt(usuarioDetalle.income) > 0 ? "not-allowed" : "pointer",
                  // Cambia el cursor cuando está deshabilitado
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.home_status || "----"} secondary="* Casa" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Ubicación domicilio" sx={estiloCampoFaltante('Ubicación domicilio')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={(usuarioDetalle.region || '----') + ", " + (usuarioDetalle.county || '----') + ", " + (usuarioDetalle.city || '----')} secondary="* Ubicación domicilio" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Número de dependientes" sx={estiloCampoFaltante('Número de dependientes')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.dependents || "-----"} secondary="* Número de dependientes" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Tipo de dependientes" sx={estiloCampoFaltante('Tipo de dependientes')} onClick={() => {
                ...
                style={{
                  cursor: usuarioDetalle.status === "1" || usuarioDetalle.dependents <= 0 ? "not-allowed" : "pointer",
                  // Cambia el cursor según el estado
                  opacity: usuarioDetalle.status === "1" || usuarioDetalle.dependents <= 0 ? 0.5 : 1 // Hace que el botón se vea deshabilitado
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.dependents > 0 ? usuarioDetalle.dependents_who || "-----" : "No tengo dependientes"} secondary="* Tipo de dependientes" />
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.education ? apiCamposConstructor.education?.values[usuarioDetalle.education] : "-----"} secondary="* Grado educativo" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Lugar de trabajo" sx={estiloCampoFaltante('Lugar de trabajo')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Posición de trabajo" sx={estiloCampoFaltante('Posición de trabajo')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Ubicación empleo" sx={estiloCampoFaltante('Ubicación empleo')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={(usuarioDetalle.work_region || '----') + ", " + (usuarioDetalle.work_county || '----') + ", " + (usuarioDetalle.workplace_address || '----')} secondary="* Ubicación empleo" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Antigüedad laboral" sx={estiloCampoFaltante('Antigüedad laboral')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.work_experience ? moment(usuarioDetalle.work_experience).calendar() + " (" + moment(usuarioDetalle.work_experience).fromNow('Y') + ")" : "----"} secondary="* Antigüedad laboral" />
                ...
                m: '0 0 2rem 0',
                color: 'silver'
              }}>Comparte el contacto de un amigo, familiar, vecino o conocido.</Typography>
                            </Grid>

                            {/* Tipo Referencia personal */}
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Tipo de referencia personal" sx={estiloCampoFaltante('Tipo de referencia personal')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_tipo_per || "----"} secondary="* Tipo referencia personal" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Nombre de referencia personal" sx={estiloCampoFaltante('Nombre de referencia personal')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_nom_per || "----"} secondary="* Nombre referencia personal" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Teléfono de referencia personal" sx={estiloCampoFaltante('Teléfono de referencia personal')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_tel_per || "----"} secondary="* Celular referencia personal" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Correo de referencia personal" sx={estiloCampoFaltante('Correo de referencia personal')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'none'
                  }} primary={usuarioDetalle.ref_correo_per || "----"} secondary="* Correo referencia personal" />
                ...
                m: '0 0 2rem 0',
                color: 'silver'
              }}>Comparte el contacto de un compañero de trabajo, jefe o cliente.</Typography>
                            </Grid>

                            {/* Tipo Referencia laboral */}
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Tipo de referencia laboral" sx={estiloCampoFaltante('Tipo de referencia laboral')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_tipo_lab || "----"} secondary="* Tipo referencia laboral" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Nombre de referencia laboral" sx={estiloCampoFaltante('Nombre de referencia laboral')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_nom_lab || "----"} secondary="* Nombre referencia laboral" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Teléfono de referencia laboral" sx={estiloCampoFaltante('Teléfono de referencia laboral')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'capitalize'
                  }} primary={usuarioDetalle.ref_tel_lab || "----"} secondary="* Celular referencia laboral" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Correo de referencia laboral" sx={estiloCampoFaltante('Correo de referencia laboral')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1 // Hace que el botón se vea deshabilitado con menor opacidad
                                    ...
                                    <ListItemText primaryTypographyProps={{
                    textTransform: 'none'
                  }} primary={usuarioDetalle.ref_correo_lab || "----"} secondary="* Correo referencia laboral" />
                ...
                m: '0 0 2rem 0',
                color: 'silver'
              }}>Comparte el comprobante digital de los documentos solicitados</Typography>
                            </Grid>

                            
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Identidad frontal" sx={estiloCampoFaltante('Identidad frontal')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  cursor: usuarioDetalle.status === "1" ? "not-allowed" : "pointer",
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1
                }}>
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Identidad trasera" sx={estiloCampoFaltante('Identidad trasera')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1
                                    ...
                                    <ListItemText primary={usuarioDetalle.file2 ? usuarioDetalle.file2.substr(-19) : "-----"} secondary="* Identidad trasera" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Recibo público" sx={estiloCampoFaltante('Recibo público')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1
                                    ...
                                    <ListItemText primary={usuarioDetalle.file3 ? usuarioDetalle.file3.substr(-19) : "-----"} secondary="* Recibo público" />
                            ...
                            <Grid item xs={12} sm={6}>
                            <List>
                                <ListItemButton id="campo-Foto selfie" sx={estiloCampoFaltante('Foto selfie')} onClick={() => {
                  if (usuarioDetalle.status === "0") {
                ...
                style={{
                  ...
                  opacity: usuarioDetalle.status === "1" ? 0.5 : 1
                                    ...
                                    <ListItemText primary={usuarioDetalle.file4 ? usuarioDetalle.file4.substr(-19) : "-----"} secondary="* Foto Selfie" />
                ...
                color: 'silver'
                                ...
                                {!tieneTodosCamposObligatoriosHechos() && <Typography component="button" variant="body2" onClick={irAlPrimerCampoFaltante} sx={{
                mb: 2,
                color: '#d32f2f',
                display: 'block',
                width: '100%',
                ...
                textDecoration: 'underline'
                                ...
                                {tieneTodosCamposObligatoriosHechos() && !perfilModificado && <Typography variant="body2" sx={{
                mb: 2,
                color: '#d32f2f'
              }}>
                                    Debes modificar al menos un campo de tu perfil antes de enviarlo a validar.
                                </Typography>}
                            </Grid>
              ...
              disabled={!tieneTodosCamposObligatoriosHechos() || !perfilModificado}
              >
                    ...
                    try {
                      ...
                      console.error("Error al enviar los datos al endpoint DecisionRules:", error);
                            ...
                            <Dialog open={successDialogOpen} onClose={() => {}} disableEscapeKeyDown>
                ...
                <TerminarRegistro open={openterminarreg} cerrar={() => {
        set_openterminarreg(false);
      }} todosaliobienfn={reiniciarpantalla} />
                <Dialog onClose={() => {
        set_openEditarCampos(false);
      }} open={openEditarCampos}>
                    <DialogContent>
                        {moduloEditarActivo === 'nombres' && <FormEditNombres cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'income' && <FormEditIncome cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'telefono' && <FormEditTelefono cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'tipoingreso' && <FormEditTipoIngreso cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} apiCamposConstructor={apiCamposConstructor} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'estadocivil' && <FormEditEstadoCivil cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} apiCamposConstructor={apiCamposConstructor} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'ubicacion' && <FormEditUbicacion cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalleFullR={usuarioDetalleFullR} />}
                        {moduloEditarActivo === 'vivienda' && <FormEditVivienda cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} apiCamposConstructor={apiCamposConstructor} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'lugartrabajo' && <FormEditLugarTrabajo cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'numerodependientes' && <FormEditNumeroDependientes cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'dependendeti' && <FormEditDependeti cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'gradoeducativo' && <FormEditGradoEducativo cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} apiCamposConstructor={apiCamposConstructor} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'antiguedadlaboral' && <FormEditAntiguedadLaboral cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'tiporeferenciapersonal' && <FormEditTipoReferenciaPersonal cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'referenciapersonal' && <FormEditReferenciaPersonal cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'celularreferenciapersonal' && <FormEditReferenciaTelefono cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'correoreferenciapersonal' && <FormEditCorreoReferenciaPersonal cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'tiporeferencialaboral' && <FormEditTipoReferenciaLaboral cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'referencialaboral' && <FormEditReferenciaLaboral cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'celularreferencialaboral' && <FormEditReferenciaTelefonoLaboral cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'correoreferencialaboral' && <FormEditCorreoReferenciaLaboral cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        ...
                        {moduloEditarActivo === 'cambiarpass' && <FormCambiarClave cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'banco' && <FormCambiarBanco cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} apiCamposConstructor={apiCamposConstructor} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'file1' && <FormEditFile1 cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'file2' && <FormEditFile2 cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'file3' && <FormEditFile3 cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'file4' && <FormEditFile4 cerrar={() => {
            set_openEditarCampos(false);
          }} usuarioFiles={usuarioFiles} reiniciarpantalla={reiniciarpantalla} />}
                        {moduloEditarActivo === 'posiciontrabajo' && <FormEditWorkplacePosition cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalle={usuarioDetalle} />}
                        {moduloEditarActivo === 'ubicaciontrabajo' && <FormEditUbicacionTrabajo cerrar={() => {
            set_openEditarCampos(false);
          }} reiniciarpantalla={reiniciarpantalla} usuarioDetalleFullR={usuarioDetalleFullR} />}
                        </DialogContent>
                </Dialog>
                ...
                {/* Modal */}
                <Dialog className="miDialogo" open={open} // El diálogo se mostrará si 'open' es true
      onClose={handleClose} // Cuando se cierra el diálogo, llamamos a la función 'handleClose'
      aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description" style={{
        display: 'flex',
        justifyContent: 'center',
        alignItems: 'center'
      }}>
          ...
          alignItems: 'center',
          fontWeight: 'bold'
        }}>{"¡Felicidades!"}</DialogTitle>
                    <DialogContent>
                        <DialogContentText className="miDialogoTexto" id="alert-dialog-description" style={{
            color: 'white',
            textAlign: 'center'
          }}>
                    ...
                    <DialogActions className="miDialogoAcciones" style={{
          display: 'flex',
          justifyContent: 'center'
        }}>
                        <Button className="miDialogoBoton" onClick={handleClose} to="/main" color="primary" autoFocus style={{
            background: 'white',
            alignContent: 'center',
            fontSize: '12px',
            borderRadius: '20px',
...
function FormEditAntiguedadLaboral({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
      ...
      mb: '1rem'
    }}>Ingresa la antiguedad laboral.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
          ...
          openTo="year" maxDate={moment().subtract(1, 'years')._d} minDate={moment().subtract(20, 'years')._d} label="Inicio de labores" value={inputFechaIngresoTrabajo.valor} onChange={handleChange_inputFechaIngresoTrabajo} renderInput={params => <TextField {...params} autoComplete="off" onBlur={() => {
            set_inputFechaIngresoTrabajo({
              ...inputFechaIngresoTrabajo,
              blur: true
            });
          }} fullWidth required error={!inputFechaIngresoTrabajo.validado && inputFechaIngresoTrabajo.blur} />} />

                    </LocalizationProvider>
                </Grid>
                <Grid item xs={12} sm={12}>
                    <Button disabled={validado && !enviandoForm ? false : true} variant="contained" onClick={guardarDatos} sx={{
          mt: 1,
          mr: 1
        }}>{enviandoForm ? "Enviando...." : "Guardar cambios"}</Button>
...
function FormEditTipoReferenciaPersonal({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Selecciona el tipo de referencia personal.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField select fullWidth label="Tipo referencia personal" value={inputRefTipoPer.valor} onChange={handleChange_inputRefTipoPer} onBlur={() => set_inputRefTipoPer({
          ...inputRefTipoPer,
          blur: true
        })} required error={!inputRefTipoPer.validado && inputRefTipoPer.blur} helperText={!inputRefTipoPer.validado && inputRefTipoPer.blur ? inputRefTipoPer.textoAyuda : ""}>
                ...
                <Grid item xs={12} sm={12}>
                    <Button disabled={!validado || enviandoForm} variant="contained" onClick={guardarDatos} sx={{
          mt: 1,
          mr: 1
        }}>
...
function FormEditReferenciaPersonal({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el nombre de referencia personal.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Referencia personal" value={inputRefNomPer.valor} onChange={handleChange_inputRefNomPer} onBlur={() => set_inputRefNomPer({
          ...inputRefNomPer,
          blur: true
        })} required error={!inputRefNomPer.validado && inputRefNomPer.blur} helperText={!inputRefNomPer.validado && inputRefNomPer.blur ? "Este campo es obligatorio" : ""} />
...
function FormEditReferenciaTelefono({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el teléfono de referencia personal.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Teléfono referencia personal" value={inputRefTelPer.valor} onChange={handleChange_inputRefTelPer} onBlur={() => set_inputRefTelPer({
          ...inputRefTelPer,
          blur: true
        })} required error={!inputRefTelPer.validado && inputRefTelPer.blur} helperText={!inputRefTelPer.validado && inputRefTelPer.blur ? "Debe ser un número de 8 dígitos" : ""} />
...
function FormEditCorreoReferenciaPersonal({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el correo de referencia personal.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Correo referencia personal" value={inputRefCorreoPer.valor} onChange={handleChange_inputRefCorreoPer} onBlur={() => set_inputRefCorreoPer({
          ...inputRefCorreoPer,
          blur: true
        })} required error={!inputRefCorreoPer.validado && inputRefCorreoPer.blur} helperText={!inputRefCorreoPer.validado && inputRefCorreoPer.blur ? "Debe ser un correo válido con @dominio" : ""} />
...
function FormEditTipoReferenciaLaboral({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Selecciona el tipo de referencia laboral.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField select fullWidth label="Tipo referencia laboral" value={inputRefTipoLab.valor} onChange={handleChange_inputRefTipoLab} onBlur={() => set_inputRefTipoLab({
          ...inputRefTipoLab,
          blur: true
        })} required error={!inputRefTipoLab.validado && inputRefTipoLab.blur} helperText={!inputRefTipoLab.validado && inputRefTipoLab.blur ? inputRefTipoLab.textoAyuda : ""}>
...
function FormEditReferenciaLaboral({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el nombre de referencia laboral.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Referencia laboral" value={inputRefNomLab.valor} onChange={handleChange_inputRefNomLab} onBlur={() => set_inputRefNomLab({
          ...inputRefNomLab,
          blur: true
        })} required error={!inputRefNomLab.validado && inputRefNomLab.blur} helperText={!inputRefNomLab.validado && inputRefNomLab.blur ? "Este campo es obligatorio" : ""} />
...
function FormEditReferenciaTelefonoLaboral({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el teléfono de referencia laboral.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Teléfono referencia laboral" value={inputRefTelLab.valor} onChange={handleChange_inputRefTelLab} onKeyPress={handleKeyPress} // Restringir entrada a números
        onBlur={() => set_inputRefTelLab({
          ...inputRefTelLab,
          blur: true
        })} required error={!inputRefTelLab.validado && inputRefTelLab.blur} helperText={!inputRefTelLab.validado && inputRefTelLab.blur ? inputRefTelLab.textoAyuda : ""} inputProps={{
          inputMode: 'numeric',
          pattern: '[0-9]*'
...
function FormEditCorreoReferenciaLaboral({
  cerrar,
  reiniciarpantalla,
  usuarioDetalle
}) {
  ...
  return <Box>
            ...
            <Typography variant="body" sx={{
      mb: '1rem'
    }}>Ingresa el correo de referencia laboral.</Typography>
            <Grid sx={{
      mt: 1,
      mb: 1
    }} container spacing={2}>
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth label="Correo referencia laboral" value={inputRefCorreoLab.valor} onChange={handleChange_inputRefCorreoLab} onBlur={() => set_inputRefCorreoLab({
          ...inputRefCorreoLab,
          blur: true
        })} required error={!inputRefCorreoLab.validado && inputRefCorreoLab.blur} helperText={!inputRefCorreoLab.validado && inputRefCorreoLab.blur ? inputRefCorreoLab.textoAyuda || "Debe ser un correo válido con @dominio" : ""} />
