            ...
            <Box sx={{p: '4px', width: '100%'}}>
                ...
                <DialogContent>
                    ...
                    {n1coPaso === "esperando" && (
                        <>
                            ...
                            <Typography variant="body2" sx={{ mb: 2 }}>
                                Estamos esperando la confirmación del proveedor de pago (N1co).
                            ...
                            <Typography variant="body2" sx={{ mb: 1 }}>
                                Si cierras la ventana antes de que el pago se complete:
                            </Typography>

                            <Typography component="ul" variant="body2" sx={{ pl: 3, mb: 2 }}>
                                <li>La validación se interrumpe.</li>
                                <li>El pago no se registra automáticamente.</li>
                                <li>Será necesario validarlo manualmente al final del día.</li>
                            </Typography>

                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                👉 Por favor, mantén la ventana abierta hasta ver la confirmación del pago.
                            </Typography>
                        </>
                    )}
                    ...
                    {n1coPaso === "pagado" && (
                        <Typography
                            variant="body2"
                            sx={{ mb: 2, mt: 1, fontWeight: "bold", color: "green" }}
                        >
                            ✅ Pago recibido
                        </Typography>
                    )}
                    ...
                    {n1coLink && (
                        <Typography sx={{ mt: 2, wordBreak: "break-all" }}>
                            Link generado:{" "}
                            <a href={n1coLink} target="_blank" rel="noreferrer">
                ...
                >
                    <DialogContent>
                        <Typography variant="h6">Ya existe un intento de pago pendiente</Typography>

                        <Typography variant="body2" sx={{ mt: 2, whiteSpace: "pre-line" }}>
                            Hay un pago en proceso para esta cuota que no se validó automáticamente porque la ventana se cerró antes de recibir la confirmación del proveedor de pago.
                            Puedes continuar de la siguiente manera:

                            {"\n\n"}
                            - Generar un nuevo link para intentar el pago nuevamente
                            {"\n"}
                            - Esperar la validación manual del intento anterior, que se realiza al final del día.

                            {"\n\n"}
                            ⚠️ Para evitar este inconveniente, asegúrate de no cerrar la ventana hasta que el pago sea confirmado.
                        </Typography>
                    </DialogContent>
                ...
                >
                    <DialogContent>
                        ...
                        <Typography variant="body2" sx={{ mt: 2 }}>
                            No cierres esta ventana mientras realizas tu pago.
                        </Typography>

                        <Typography variant="body2" sx={{ mt: 2 }}>
                            Al presionar <strong>Entendido</strong>:
                        </Typography>

                        <Typography component="ul" variant="body2" sx={{ mt: 1, pl: 3 }}>
                            <li>Se generará tu link de pago.</li>
                            <li>Serás redirigido automáticamente a N1co para completar la transacción.</li>
                            <li>Esta ventana quedará abierta mientras esperamos la confirmación del pago.</li>
                        </Typography>
                        ...
                        <Typography variant="body2" sx={{ mt: 1 }}>
                            Debes mantener esta ventana abierta hasta que el sistema confirme que el pago fue recibido.
                            Si la cierras antes, el pago no se validará automáticamente y podría requerir revisión manual
                            al final del día por un agente.
                        </Typography>

                        <Typography variant="body2" sx={{ mt: 2 }}>
                            👉 Presiona <strong>Entendido</strong> solo cuando estés listo para continuar con el pago.
                        </Typography>
                    </DialogContent>
